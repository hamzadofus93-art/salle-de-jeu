export const elements = {
  ...
  startTableOptions: document.querySelector("#start-table-options"),
  startSubmit: document.querySelector("#start-submit"),
  playerOne: document.querySelector("#player-one"),
  playerOneOptions: document.querySelector("#player-one-options"),
  playerTwo: document.querySelector("#player-two"),
  playerTwoOptions: document.querySelector("#player-two-options"),
  ...
  finishTableOptions: document.querySelector("#finish-table-options"),
  ...
  accountRoleOptions: document.querySelector("#account-role-options"),
